...
par(mfrow=c(1,1))
par(mfrow=c(3,1))
plot(GOES.time, GOES_NDVI,main="GOES NDVI",ylim=c(0,1))
plot(PC.time,y,col="Blue")

plot(MODIS.time,EVI,main="Phenology at Harvard Forest in 2017",xlab="Time",ylab="Value")
points(PC.time,y,col="Red")
points(GOES.time, GOES_NDVI,col="Blue")
legend("topleft",c("MODIS EVI","PhenoCam","GOES NDVI"),pch=c("o","o","o"),col=c("Black","Red","Blue"))
