...
##' @import ecoforecastR
##' @import rjags
plotForecastOutput <- function(siteName,forecastType,URL,forecastLength,outBurn){
  ...
  ##Plot
  plot(timeForecast,ci[2,],type='n',xlab="Time",ylab="Percent Canopy",main=paste(siteName,forecastType),cex.lab=1.5,cex.main=2,ylim=c(0,1))
