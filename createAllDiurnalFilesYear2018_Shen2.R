...
siteName <- as.character(siteData[18,1]) #shenandoah
lat <- as.numeric(siteData[18,2])
long <- as.numeric(siteData[18,3])

timeFrames <- matrix(ncol=3,nrow=23)
timeFrames[1,] <- c(1,7,"NEW") #Jan1
timeFrames[2,] <- c(8,13,"NEW") #Jan1
timeFrames[3,] <- c(14,19,"NEW") #Jan1
timeFrames[4,] <- c(20,25,"NEW") #Jan2
timeFrames[5,] <- c(26,31,"NEW") #Jan2
timeFrames[6,] <- c(32,38,"NEW") #Jan2

timeFrames[7,] <- c(39,44,"NEW")
timeFrames[8,] <- c(45,49,"NEW")
timeFrames[9,] <- c(50,54,"NEW") #Feb 2
timeFrames[10,] <- c(55,59,"NEW") #Feb 2
timeFrames[11,] <- c(60,66,"NEW") #Jan2

timeFrames[12,] <- c(67,72,"NEW")
timeFrames[13,] <- c(73,79,"NEW")
timeFrames[14,] <- c(80,84,"NEW") #March 2
timeFrames[15,] <- c(85,90,"NEW") #March 2
timeFrames[16,] <- c(91,97,"NEW") #Jan2
timeFrames[17,] <- c(98,109,"NEW")
timeFrames[18,] <- c(110,120,"NEW") #April 2
 
timeFrames[19,] <- c(128,139,"NEW")
timeFrames[20,] <- c(140,151,"NEW") #May 2
 
timeFrames[21,] <- c(152,158,"NEW")
timeFrames[22,] <- c(159,170,"NEW")
timeFrames[23,] <- c(171,181,"NEW") #June 2
