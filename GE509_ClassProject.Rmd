...
#plot(x=list(),y=list(),xlim=c(180,365),ylim=c(0,1))
#lines(x.GOES,var.GOES.pred,col="Black")
#points(out.GOES$x,out.GOES$y,col="Black")
#lines(xpred,ci[1,], col="black", lty = 2)
#lines(xpred,ci[3,],col="black",lty=2)
...
#points(out.MODIS$x,out.MODIS$y)
...
lines(xpred,ci[1,], col="green", lty = 2)
lines(xpred,ci[3,],col="green",lty=2)
